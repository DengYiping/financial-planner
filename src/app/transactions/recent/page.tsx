...
export default async function TransactionsRecentPage({
  searchParams,
}: {
  ...
  const canonicalUrl = canonicalTransactionsUrl("/transactions/recent", view.selectedMonth);
  ...
  return (
    <main className="mx-auto max-w-6xl px-5 pb-12 pt-10 sm:px-8 lg:pt-14">
      ...
      <TransactionsContent transactionTab="recent" view={view} />
    </main>
  );
}
